export default {
	...
	'analog-to-dpad-deadzone-text': 'Specify the shape and size of the analog deadzone. Squareness warp adjusts the shape to be more like a physical lever.',
	'analog-to-dpad-deadzone-label': 'Deadzone Size (%)',
	'analog-to-dpad-squareness-label': 'Squareness Warp',
	'analog-to-dpad-debounce-label': 'Debounce (%)',
	'analog-to-dpad-source-label': 'Input Source',
	'analog-to-dpad-source-1': 'Analog Stick 1',
	'analog-to-dpad-source-2': 'Analog Stick 2',
	'analog-to-dpad-mode-8-way': '8-way',
	'analog-to-dpad-mode-4-way': '4-way',
	'analog-to-dpad-switch-8way-options-text': 'Slope and Offset adjust the virtual cardinal switch angles and positions. Debouncing is the distance between the virtual switch turning on and off.',
	'analog-to-dpad-switch-4way-options-text': 'Offset adjusts the virtual cardinal switch positions. Debouncing is the distance between the virtual switch turning on and off.',
	'analog-to-dpad-switch-slope-label': 'Cardinal Slope (%)',
	'analog-to-dpad-switch-offset-label': 'Cardinal Offset (%)',
	'analog-to-dpad-switch-4way-size-label': 'Switch Distance',
